             ...
             getPropertyEfficiencies(function(propertyefficiencies){
                 getPropertyStatus(function(propertystatues){
                     getPropertyTypes(function(propertytypes){
                        ...
                        ModalMaker.addDateInput("yearbuilt", "Date Built*", "", moment().format('YYYY-MM-DD HH-mm-ss')).addClasses("col-xs-12 col-md-6");
                        ModalMaker.endGroup();
                        ...
                        ModalMaker.addLocationMap("gpslat", "gpslng", "Map Location", "Latitude", "Longitude", "./images/pin.png",51.74707580198669,-1.7022948301319047);
                        ModalMaker.endGroup();
